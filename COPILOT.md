...
For this repo, merge-gate baseline is:
...
Backlog priorities are tracked in `docs/implementation-issues.md`; mirror active work into `tasks/todo.md` before coding.
